...
async def forward(bot, message):
    ...
    acount = random.randint(50000, 60000)
    bcount = random.randint(15000, 20000)
    ccount = random.randint(10000, 30000)
            ...
            if methord == "bot":
                ...
                if mcount:
                    if acount:
                        if bcount:
                            if ccount:
                                ...
                                bcount -= 1
                                MessageCount += 1
                                mainsleep=random.randint(0, 0, 0, 0, 0, 5, 1, 1, 1, 1, 1, 8, 4)
                                try:
                                    datetime_ist = datetime.now(IST)
                                    ISTIME = datetime_ist.strftime("%I:%M:%S %p - %d %B %Y")
                                ...
                                print(f"Starting after {csleep/2} minutes")
                            ...
                            try:
                                ...
                                pass
                            bsl=random.randint(10000, 12000)
                            try:
                                datetime_ist = datetime.now(IST)
                                ISTIME = datetime_ist.strftime("%I:%M:%S %p - %d %B %Y")
                        ...
                        try:
                            ...
                            pass
                        asl=random.randint(15000, 20000)
                        try:
                            datetime_ist = datetime.now(IST)
                            ISTIME = datetime_ist.strftime("%I:%M:%S %p - %d %B %Y")
                    ...
                    try:
                        ...
                        pass
                    msl=random.randint(20000, 30000)
                    try:
                        datetime_ist = datetime.now(IST)
                        ISTIME = datetime_ist.strftime("%I:%M:%S %p - %d %B %Y")
